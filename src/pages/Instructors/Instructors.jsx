...
const Instructors = () => {
  ...
  return (
    <>
      <Helmet>
        <title>FightingSpirit - Instructors</title>
      </Helmet>
      <div className={`${darkMode ? "text-gray-300" : ""} my-16 space-y-8`}>
        <div className="md:w-[80%] mx-auto md:text-center space-y-4">
          <Fade cascade damping={0.2}>
            <h2 className="text-center text-3xl font-bold">
              Meet Our <u className="text-primary">Martial Art Instructors</u>
            </h2>
            <p>
              Our talented and passionate martial art instructors at Fighting Spirit martial art
              ...
              and ignite a love for martial art in a dynamic learning environment. Get
              ...
              Elevate your fighting experience with our inspiring instructors at
              Fighting Spirit martial art School.
            </p>
          </Fade>
        </div>
