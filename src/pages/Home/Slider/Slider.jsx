        ...
        <div className="bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] absolute flex items-center gap-4 left-0 top-0 h-full">
          <div className="md:w-[50%] ml-4 md:ml-32 text-white space-y-2 md:space-y-4">
            ...
            <p className="text-sm md:text-base hidden md:block">
              Ignite your passion for movement and discover the joy of martial art at
              our dynamic martial art camp!
            </p>
      ...
      <div className="relative">
        ...
        <div className="bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] absolute flex items-center gap-4 left-0 top-0 h-full">
          <div className="md:w-[50%] ml-4 md:ml-32 text-white space-y-2 md:space-y-4">
            ...
            <p className="text-sm md:text-base hidden md:block">
              Elevate your martial art journey and explore diverse styles in an
      ...
      <div className="relative">
        ...
        <div className="bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] absolute flex items-center gap-4 left-0 top-0 h-full">
          <div className="md:w-[50%] ml-4 md:ml-32 text-white space-y-2 md:space-y-4">
            ...
            <p className="text-sm md:text-base hidden md:block">
              Unleash your fighting potential, push boundaries, and embrace your
              unique style at our transformative martial art camp!
            </p>
            <Link className="inline-flex items-center px-2 md:px-4 py-1 md:py-2 text-sm md:text-base font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-md hover:bg-gray-100">
              Get in touch
            </Link>
      ...
      <div className="relative">
        ...
        <div className="bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] absolute flex items-center gap-4 left-0 top-0 h-full">
          <div className="md:w-[50%] ml-4 md:ml-32 text-white space-y-2 md:space-y-4">
            ...
            <p className="text-sm md:text-base hidden md:block">
              practice to your own beat and immerse yourself in the enchanting
              world of martial art at our captivating martial art camp!
            </p>
            <Link className="inline-flex items-center px-2 md:px-4 py-1 md:py-2 text-sm md:text-base font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-md hover:bg-gray-100">
              Get in touch
            </Link>
