      ...
      <Fade cascade damping={0.2}>
        <div className="flex justify-center">
          ...
          >
            ...
            >
              FightingSpirit is an exciting and dynamic martial art school that brings
              together students of all ages and levels to explore the world of
              martial art. With a team of talented instructors and a vibrant
              community, we create an immersive and inspiring environment where
              students can learn, grow, and express themselves through the art of
              fight. At FightingSpirit, we believe in the power of martial art to
              transform lives and build lifelong connections.
            </p>
          </div>
        </div>
      </Fade>
      ...
      <div className="grid gap-x-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-x-12">
        <Fade cascade damping={0.2}>
          <div className={`${darkMode ? "text-gray-300" : ""} mb-12 lg:mb-0`}>
            ...
            >
              We provide round-the-clock assistance to ensure that students
          ...
          <div className={`${darkMode ? "text-gray-300" : ""} mb-12 lg:mb-0`}>
            ...
            >
              Our martial art school prioritizes the safety and well-being of our
          ...
          <div className={`${darkMode ? "text-gray-300" : ""} mb-12 lg:mb-0`}>
            ...
            >
              ...
              students to see significant improvement in their skills and
              technique.
            </p>
          </div>
          ...
          <div className={`${darkMode ? "text-gray-300" : ""} mb-12 lg:mb-0`}>
            ...
            >
              ...
              to help students track their progress, identify areas for
              improvement.
            </p>
          </div>
        </Fade>
