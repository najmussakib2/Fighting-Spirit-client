      ...
      <Fade cascade damping={0.2}>
        <div className="md:w-[80%] mx-auto md:text-center space-y-4 mb-8">
          <h2 className="text-center text-3xl font-bold">
            Popular <u className="text-primary">Instructors</u>
          </h2>
          <p>
            Meet our highly sought-after martial art instructors who have captured the
            hearts of martial art students at fighting spirit martial art School. These talented and
